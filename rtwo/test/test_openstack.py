...
from libcloud.test import MockResponse, MockHttpTestCase
...
class OpenStackEshDriverTest(unittest.TestCase, TestCaseMixin):
    ...
    def create_driver(self):
        if self is not OpenStack_Esh_FactoryMethodTests:
...
class OpenStack_Esh_FactoryMethodTests(OpenStackEshDriverTest):
...
class OpenStack_1_1_MockHttp(OpenStackMockHttp):
    auth_fixtures = OpenStackFixtures()
    json_content_headers = {'content-type': 'application/json; charset=UTF-8'}
